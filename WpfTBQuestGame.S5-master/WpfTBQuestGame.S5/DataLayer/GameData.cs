    ...
    public class GameData
    {
        ...
        public static Map GameMap()
        {
            ...
            gameMap.MapLocation[2, 1] = new Location()
            {
                ...
                GameItems = new ObservableCollection<GameItemQuantity>()
                {
                    new GameItemQuantity(GameItemById(2001),20),
                                                            new GameItemQuantity(GameItemById(4002),100)
            ...
            gameMap.MapLocation[4, 0] = new Location()
            {
                ...
                GameItems = new ObservableCollection<GameItemQuantity>
                {
                    new GameItemQuantity(GameItemById(4005), 1),
        ...
        public static List<GameItem> StandardGameItems()
        {
            return new List<GameItem>()
            {
                ...
                new Allies(4002,"Roose Bolton Allies",100,"Allies came from Roose Bolton",3,"You got Allies from Roose",Allies.UseActionType.AddXP),
        ...
        public static List<Npc> Npcs()
        {
            return new List<Npc>()
            {
                 ...
                 new Military()
                {
                    ...
                    Description = "Arya Stark is the youngest daughter and third child of Lady Catelyn and Lord Ned Stark.",
                    Messages = new List<string>()
                    {
                   ...
                   new Military()
                {
                    ...
                    Name = "Jon Snow",
                    House = Character.HouseName.Stark,
                    Description = "Born Aegon Targaryen, is the son of Lyanna Stark and Rhaegar Targaryen, the late Prince of Dragonstone. From infancy, Jon is presented as the bastard son of Lord Eddard Stark, Lyanna's brother, and raised alongside his lawful children at Winterfell, the seat of House Stark. ",
                    Messages = new List<string>()
                    {
                     ...
                     new Military()
                {
                    ...
                    Name = "Sansa Stark",
                    House = Character.HouseName.Stark,
                    Description = "Sansa Stark is the eldest daughter and second child of Lady Catelyn and Lord Eddard Stark, the Warden of the North.",
                    Messages = new List<string>()
                    {
