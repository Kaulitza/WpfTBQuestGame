...
namespace WpfTheAionProject.PresentationLayer
{
    public class GameSessionViewModel : ObservableObject
    {
        ...
        public void AddNPCs()
        {
            if (_currentNpc != null)
            {
                ...
                else if (_currentNpc.Name == "Jon Snow")
                {
                    ...
                    _player.AddGameItemQuantityToInventory(new GameItemQuantity(GameItemById(1001), 1000));

                    CurrentLocationInformation = "You are my ally now. I will lend you my sword, Longclaw. It is the only way to kill the Night King.";
                }
                else if (_currentNpc.Name == "Sansa Stark")
                {
                    _player.AddGameItemQuantityToInventory(new GameItemQuantity(GameItemById(2002), 200));
                    CurrentLocationInformation = "Here is some money for food.";
                }
                else if (_currentlocation.name == "Empty Space")
                {
                    if (_currentNpc.Name == "Bear")
                    {
                        ...
                        else
                        {
                            ...
                            CurrentLocationInformation = "Bear attacks you\nYou lost 10 health points";
                        }
                    }
                    else if (_currentNpc.Name == "Wolf")
                    {
                        ...
                        {
                            _player.Health = _player.Health - 10;
                            CurrentLocationInformation = "Wolf attacks you\nYou lost 10 health points";
        ...
        private static List<GameItem> StandardGameItems()
        {
            ...
            {
                new Weapon(1001, "Longclaw", 5, 100, 10, "The valyrian steel sword from House Stark. Without this, you do not stand a chance of defeating the night king.", 10),
        ...
        private string GenerateMissionStatusInformation()
        {
            ...
            {
                missionStatusInformation += "Looks Like you are just starting out. No mission complete at this point. Let's get to it!";
            }
            else if(percentMissionsCompleted<=33)
            {
                missionStatusInformation += "You have some of your missions complete, but this is just a start. You have your work cut out for you for sure.";
            }
